...
// TODO: check all `Extract` if the collide with `Ref`
...
class RaylibCoreFlat extends RaylibCoreFlatModule<Raylib> {
  ...
  ColorD ColorAlphaBlend(
    ...
    (p) => rl.Core.ColorAlphaBlend.run(
      p.toJS,
      rl.Temp.Color$.Ref1(dst).toJS,
      rl.Temp.Color$.Ref2(src).toJS,
  ...
  ColorD ColorLerp(
    ...
    (p) => rl.Core.ColorLerp.run(
      p.toJS,
      rl.Temp.Color$.Ref1(color1).toJS,
      rl.Temp.Color$.Ref2(color2).toJS,
      factor.toJS,
    ),
  );
